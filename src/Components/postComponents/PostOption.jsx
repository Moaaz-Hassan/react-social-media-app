  ...
  return (
    <div className=" my-3  grid grid-cols-2 md:grid-cols-4 gap-3  bg-white  g-white w-full rounded-xl shadow-md border-1 border-blue-50  h-auto p-4 ">
      ...
      >
        ...
        <h2 className=" font-bold text-medium ">Feed</h2>
      </div>
      ...
      >
        ...
        <h2 className=" font-bold text-medium ">Community</h2>
      </div>
      ...
      >
        ...
        <h2 className=" font-bold text-medium ">My Posts</h2>
      </div>
      ...
      >
        ...
        <h2 className=" font-bold text-medium ">Saved Posts</h2>
      </div>
    </div>
  );
}
