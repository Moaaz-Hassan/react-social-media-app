      ...
      <div className="  bg-white my-2 p-4 rounded-medium ">
        <div className=" mt-5 flex mg:items-center md:flex-row flex-col gap-3 justify-between ">
          <div className=" flex  items-center gap-3  ">
            <div className="relative aspect-square w-32 bg-blue-500 rounded-full overflow-hidden">
              <img
                src={userData?.photo}
                className="w-full h-full object-cover "
              />
              {lodingPhoto ? <Spinner size="md" className="absolute bottom-1 left-1/2 -translate-x-1/2" /> : <label htmlFor="profileImage">
                <svg
